...
var DestinationRequest = function (_EventEmitter) {
    ...
    DestinationRequest.prototype._send = function _send(waitForData) {
        ...
        (0, _connectionResetGuard2.default)(function () {
            ...
            var storedHeaders = _this2.opts.headers;
            ...
            _this2.opts.headers = (0, _headerTransforms.transformHeadersCaseToRaw)(_this2.opts.headers, _this2.opts.rawHeaders);
            ...
            _this2.opts.headers = storedHeaders;
