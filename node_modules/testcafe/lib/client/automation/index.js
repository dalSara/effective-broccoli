			...
			"errors": {
				"test-run": {
					"index.js": function (exports, module, require) {
						...
						var AssertionUnawaitedPromiseError = exports.AssertionUnawaitedPromiseError = function (_TestRunErrorBase17) {
						    _inherits(AssertionUnawaitedPromiseError, _TestRunErrorBase17);

						    function AssertionUnawaitedPromiseError(callsite) {
						        _classCallCheck(this, AssertionUnawaitedPromiseError);

						        var _this19 = _possibleConstructorReturn(this, _TestRunErrorBase17.call(this, _type2.default.assertionUnawaitedPromiseError));
						...
						var ActionOptionsTypeError = exports.ActionOptionsTypeError = function (_TestRunErrorBase18) {
						    _inherits(ActionOptionsTypeError, _TestRunErrorBase18);

						    function ActionOptionsTypeError(actualType) {
						        _classCallCheck(this, ActionOptionsTypeError);

						        var _this25 = _possibleConstructorReturn(this, _TestRunErrorBase18.call(this, _type2.default.actionOptionsTypeError));

						        _this25.actualType = actualType;
						        return _this25;
						    }
						...
						var ActionStringArrayElementError = exports.ActionStringArrayElementError = function (_ActionArgumentErrorB9) {
						    ...
						    function ActionStringArrayElementError(argumentName, actualValue, elementIndex) {
						        ...
						        var _this32 = _possibleConstructorReturn(this, _ActionArgumentErrorB9.call(this, _type2.default.actionStringArrayElementError, argumentName, actualValue));

						        _this32.elementIndex = elementIndex;
						        return _this32;
						    }
						...
						var ActionSelectorError = exports.ActionSelectorError = function (_TestRunErrorBase19) {
						    _inherits(ActionSelectorError, _TestRunErrorBase19);

						    function ActionSelectorError(selectorName, errMsg) {
						        _classCallCheck(this, ActionSelectorError);

						        var _this35 = _possibleConstructorReturn(this, _TestRunErrorBase19.call(this, _type2.default.actionSelectorError));

						        _this35.selectorName = selectorName;
						        _this35.errMsg = errMsg;
						        return _this35;
						    }
						...
						var ActionElementIsInvisibleError = exports.ActionElementIsInvisibleError = function (_TestRunErrorBase20) {
						    _inherits(ActionElementIsInvisibleError, _TestRunErrorBase20);

						    function ActionElementIsInvisibleError() {
						        _classCallCheck(this, ActionElementIsInvisibleError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase20.call(this, _type2.default.actionElementIsInvisibleError));
						    }

						    return ActionElementIsInvisibleError;
						}(TestRunErrorBase);

						var ActionSelectorMatchesWrongNodeTypeError = exports.ActionSelectorMatchesWrongNodeTypeError = function (_TestRunErrorBase21) {
						    _inherits(ActionSelectorMatchesWrongNodeTypeError, _TestRunErrorBase21);
						    ...
						    function ActionSelectorMatchesWrongNodeTypeError(nodeDescription) {
						        ...
						        var _this38 = _possibleConstructorReturn(this, _TestRunErrorBase21.call(this, _type2.default.actionSelectorMatchesWrongNodeTypeError));
						...
						var ActionAdditionalElementNotFoundError = exports.ActionAdditionalElementNotFoundError = function (_SelectorErrorBase3) {
						    ...
						    function ActionAdditionalElementNotFoundError(argumentName, apiFnArgs) {
						        ...
						        var _this39 = _possibleConstructorReturn(this, _SelectorErrorBase3.call(this, _type2.default.actionAdditionalElementNotFoundError, apiFnArgs));
						...
						var ActionAdditionalElementIsInvisibleError = exports.ActionAdditionalElementIsInvisibleError = function (_TestRunErrorBase22) {
						    ...
						    function ActionAdditionalElementIsInvisibleError(argumentName) {
						        ...
						        var _this40 = _possibleConstructorReturn(this, _TestRunErrorBase22.call(this, _type2.default.actionAdditionalElementIsInvisibleError));
						...
						var ActionAdditionalSelectorMatchesWrongNodeTypeError = exports.ActionAdditionalSelectorMatchesWrongNodeTypeError = function (_TestRunErrorBase23) {
						    ...
						    function ActionAdditionalSelectorMatchesWrongNodeTypeError(argumentName, nodeDescription) {
						        ...
						        var _this41 = _possibleConstructorReturn(this, _TestRunErrorBase23.call(this, _type2.default.actionAdditionalSelectorMatchesWrongNodeTypeError));
						...
						var ActionElementNonContentEditableError = exports.ActionElementNonContentEditableError = function (_TestRunErrorBase26) {
						    ...
						    function ActionElementNonContentEditableError(argumentName) {
						        ...
						        var _this44 = _possibleConstructorReturn(this, _TestRunErrorBase26.call(this, _type2.default.actionElementNonContentEditableError));
						...
						var ActionIncorrectKeysError = exports.ActionIncorrectKeysError = function (_TestRunErrorBase28) {
						    ...
						    function ActionIncorrectKeysError(argumentName) {
						        ...
						        var _this46 = _possibleConstructorReturn(this, _TestRunErrorBase28.call(this, _type2.default.actionIncorrectKeysError));

						        _this46.argumentName = argumentName;
						        return _this46;
						    }
						...
						var ActionCanNotFindFileToUploadError = exports.ActionCanNotFindFileToUploadError = function (_TestRunErrorBase29) {
						    ...
						    function ActionCanNotFindFileToUploadError(filePaths) {
						        ...
						        var _this47 = _possibleConstructorReturn(this, _TestRunErrorBase29.call(this, _type2.default.actionCanNotFindFileToUploadError));

						        _this47.filePaths = filePaths;
						        return _this47;
						    }
						...
						var ActionInvalidScrollTargetError = exports.ActionInvalidScrollTargetError = function (_TestRunErrorBase31) {
						    ...
						    function ActionInvalidScrollTargetError(scrollTargetXValid, scrollTargetYValid) {
						        ...
						        var _this49 = _possibleConstructorReturn(this, _TestRunErrorBase31.call(this, _type2.default.actionInvalidScrollTargetError));

						        if (!scrollTargetXValid) {
						            if (!scrollTargetYValid) _this49.properties = 'scrollTargetX and scrollTargetY properties';else _this49.properties = 'scrollTargetX property';
						        } else _this49.properties = 'scrollTargetY property';
						        return _this49;
						    }
						...
						var WindowDimensionsOverflowError = exports.WindowDimensionsOverflowError = function (_TestRunErrorBase32) {
						    ...
						    function WindowDimensionsOverflowError(callsite) {
						        ...
						        var _this50 = _possibleConstructorReturn(this, _TestRunErrorBase32.call(this, _type2.default.windowDimensionsOverflowError));
						...
						var InvalidElementScreenshotDimensionsError = exports.InvalidElementScreenshotDimensionsError = function (_TestRunErrorBase33) {
						    ...
						    function InvalidElementScreenshotDimensionsError(width, height) {
						        ...
						        var _this51 = _possibleConstructorReturn(this, _TestRunErrorBase33.call(this, _type2.default.invalidElementScreenshotDimensionsError));
						        ...
						        if (widthIsInvalid) {
						            if (heightIsInvalid) {
						                _this51.verb = 'are';
						                _this51.dimensions = 'width and height';
						            } else {
						                _this51.verb = 'is';
						                _this51.dimensions = 'width';
						            }
						        } else {
						            _this51.verb = 'is';
						            _this51.dimensions = 'height';
						        }
						        return _this51;
						    }
						...
						var RoleSwitchInRoleInitializerError = exports.RoleSwitchInRoleInitializerError = function (_TestRunErrorBase34) {
						    ...
						    function RoleSwitchInRoleInitializerError(callsite) {
						        ...
						        var _this52 = _possibleConstructorReturn(this, _TestRunErrorBase34.call(this, _type2.default.roleSwitchInRoleInitializerError));

						        _this52.callsite = callsite;
						        return _this52;
						    }
						...
						var NativeDialogNotHandledError = exports.NativeDialogNotHandledError = function (_TestRunErrorBase40) {
						    ...
						    function NativeDialogNotHandledError(dialogType, url) {
						        ...
						        var _this58 = _possibleConstructorReturn(this, _TestRunErrorBase40.call(this, _type2.default.nativeDialogNotHandledError));

						        _this58.dialogType = dialogType;
						        _this58.pageUrl = url;
						        return _this58;
						    }
						...
						var UncaughtErrorInNativeDialogHandler = exports.UncaughtErrorInNativeDialogHandler = function (_TestRunErrorBase41) {
						    ...
						    function UncaughtErrorInNativeDialogHandler(dialogType, errMsg, url) {
						        ...
						        var _this59 = _possibleConstructorReturn(this, _TestRunErrorBase41.call(this, _type2.default.uncaughtErrorInNativeDialogHandler));

						        _this59.dialogType = dialogType;
						        _this59.errMsg = errMsg;
						        _this59.pageUrl = url;
						        return _this59;
						    }
						...
						var SetNativeDialogHandlerCodeWrongTypeError = exports.SetNativeDialogHandlerCodeWrongTypeError = function (_TestRunErrorBase42) {
						    ...
						    function SetNativeDialogHandlerCodeWrongTypeError(actualType) {
						        ...
						        var _this60 = _possibleConstructorReturn(this, _TestRunErrorBase42.call(this, _type2.default.setNativeDialogHandlerCodeWrongTypeError));

						        _this60.actualType = actualType;
						        return _this60;
						    }
